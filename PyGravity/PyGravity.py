...
class PyGravity(object):
    ...
    def write_file(self, file_name):
        ...
        .. todo:: fix this function. The values are not corresponding to
            known solutions
        '''
    ...
    def step_all_verlet(self):
        ...
        half_list = []
        for part1_indx in range(p_len):
            for part2_indx in range(part1_indx+1, p_len):
                half_list.append(
                    (
                        self.particle_list[part1_indx],
                        self.particle_list[part2_indx]
                    )
                )
        for pair in half_list:
            ...
            except RuntimeWarning as excpt:
                print excpt
                sys.exit(1)
