...
static char vector_math_docs[] =
    "vector_math( ): making vectors do something!!\n";

static PyMethodDef vector_funcs[] = {
    
       { "grav_accel", grav_accel, METH_VARARGS, NULL },
    {NULL}
};

void initvector_math(void)
{
    Py_InitModule3("vector_math", vector_funcs,
